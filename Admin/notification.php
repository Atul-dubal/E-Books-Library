...
<h1 class=" text-center text-dark">Notification 
</h1>
</div>
</div>
</div>
   ...
   <div class="row" >
       <div class="col-12">
           <div class="table-responsive">
            ...
            <tr>
                <th>SR.No</th>
                                <th>Full Name</th>                <th>Email</th>                <th>Phone</th>                <th>Message</th> 
                            <th>Type</th> 
                        <th>Status</th>
            </tr>
        </thead>
            ...
            <tr>
                <td>
                    <?php echo$i; $i++;?>
                                ...
                                <td>                    <?php echo$data["Full Name"];?></td>                <td>                    <?php echo$data["Email"];?></td>                <td>                    <?php echo$data["Phone_number"];?></td>                <td>                    <?php echo$data["Message"];?></td> 
                                
                        <td>                    <?php echo$data["Msg_Type"];?></td>
                        <td>    <input hidden type="text" value="<?php echo$data["Id"];?>" />
                        <?php echo$data["Status"];?>
             <i style="font-size:25px" class="fa fa-edit m-1"/>
...
<?php } else{
    ?><p class="my-3 alert alert-danger container text-center">You Don't have any Notification</p><?php }?>
